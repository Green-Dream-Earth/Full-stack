...
const CookieConsentBanner = () => {
    ...
    const handleScroll = () => {
        ...
        if (element) {
            ...
            if (top < window.innerHeight) {
                setIsVisible(true);
                window.removeEventListener('scroll', handleScroll); // Stop checking after it appears once
            }
        }
    };
    ...
    return (
        <section
            ref={ref}
            className={`fixed transition-opacity duration-500 delay-500 z-40 max-w-md p-4 mx-auto bg-white border border-gray-200 mx-auto md:left-20 bottom-16 rounded-2xl ${
        ...
        >
            ...
            <p className="mt-4 text-sm text-gray-600">
                ...
                <a href="/terms-and-policy" className="text-blue-500 hover:underline">
